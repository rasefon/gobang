...
int Board::s_pattern_len[PATTERN_NUM];
int *Board::s_failure_function[PATTERN_NUM];

void Board::compute_failure_function()
{
...
int Board::kmp_matcher(char *target, int target_len, char *pattern, int pattern_index, int pattern_len)
{
